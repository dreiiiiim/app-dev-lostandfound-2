...
// export default function createLostItemsRouter(db) {
...
//   router.delete("/api/lost-items/:id", async (req, res) => {
//     const { id } = req.params;
//     try {
...
//       res.json({ success: true, message: "Item successfully claimed and removed." });
//     } catch (err) {
//       console.error(err);
//       res.status(500).json({ message: "Server error" });
//     }
