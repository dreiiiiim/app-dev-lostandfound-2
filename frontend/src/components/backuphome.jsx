...
import LostItemsModal from "./components/LostItemsModal";
import FoundItemsModal from "./components/FoundItemsModal"; // Add this import
  ...
  return (
    <div className="w-full min-h-screen font-sans bg-white">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <input
              type="text"
              placeholder="Search"
              className="w-48 lg:w-64 px-4 py-1 rounded-full border border-gray-300 focus:outline-none text-sm bg-white transition-all duration-300 focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="flex items-center gap-3">         
            ...
            <button className="hidden md:flex items-center justify-center px-5 py-1.5 bg-white rounded-full shadow text-sm transition-all duration-300 hover:shadow-md hover:translate-y-[-1px] active:translate-y-[1px] active:shadow-sm active:bg-gray-50">
              Sign Out
            </button>
      ...
      <section className="w-full h-[70vh] bg-cover bg-center relative overflow-hidden">
        <div className="absolute inset-0 brightness-30" style={{backgroundImage: "url('/image/bg2.png')", backgroundSize: "cover", backgroundPosition: "center"}}></div>
